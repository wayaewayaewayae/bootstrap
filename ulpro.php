...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
               ...
               <form class="form-inline my-2 my-lg-0" action="logout.php" method="post">
                    <button class="btn btn-danger my-2 my-sm-0" type="submit" name="send">Logout</button>
                </form>
            </div>
        </nav>
    </header>
    ...
    <div class="container">
        <div class="row justify-content-lg-center" style="padding:20px;">
            <div class="col-md-12">
                <div class="card text-primary bg-with mb-3 align-content-center">
                    <div class="card-header">Info Pembelian Barang</div><br>
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tr>
                                    <th colspan="10"><center>Daftar Barang Yang Dibeli</center></th>
                                </tr>
                            ...
                            <table class="table">
                                <tr>
                                    <th colspan="10"><center>Total Yang Harus di Bayar</center></th>
                                </tr>
                                <tr>
                                    <td>Sub Total</td>
