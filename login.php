    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark bg-success">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="form-inline my-2 my-lg-0" action="ul1.php" method="post">
                    <button class="btn btn-primary my-2 my-sm-0" type="submit" name="send">Login</button>
                </form>
            </div>
        </nav>
    </header>
            ...
            <div class="col-md-4 m-auto">
                <div class="card">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                            <input type="submit" value="Log-in" name="send" class="btn btn-primary">
                        </div>
                    </form>
                    </div>
                </div>
