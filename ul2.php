                    ...
                    <div class="card-header">Data Barang</div>
                         <div class="card-body">
                            ...
                            <div class="card-body">
                             ...
                             <form action="ulpro.php" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select custom-select-md mb-3" name="jenis[]">
                                            <option value="Alat Tulis" selected>Alat Tulis</option>
                                ...
                                <div class="form-group">
                                    <input type="submit" value="Simpan" name ="send" class=" btn btn-success btn-success">
                                </div>
